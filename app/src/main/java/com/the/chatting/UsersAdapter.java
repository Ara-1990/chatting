...
import com.the.chatting.databinding.ItemConteinerUserBinding;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder> {
    ...
    public UsersAdapter(List<com.the.chatting.User> users, UserListener userListener) {
        this.users = users;
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        void setUserData(com.the.chatting.User user) {
